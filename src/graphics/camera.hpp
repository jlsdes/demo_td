...
public:
    ...
    /** Manage the movement speed of the camera; default = 1. */
    [[nodiscard]] float get_speed() const;
    void set_speed( float speed );

    /** Manage the rotation sensitivity of the camera; default = 1. */
    ...
    /** Toggles whether the camera should move in one of the main directions (enumerated in), depending on the
    ...
    void toggle_movement( Action action, bool is_pressing );
...
private:
    ...
    std::bitset<NumberActions> m_movement;
